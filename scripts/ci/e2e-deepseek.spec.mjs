import { chromium, expect, test } from 'playwright'
...
test('DeepSeek E2E: login, paste, analyze, validate', async () => {
  ...
  // Force DeepSeek preview via toggle if available, else rely on backend defaults
