...
export async function callDeepseekPreview(opts: {
  ...
  try {
    const systemPrompt = [
      'أنت مساعد MUST إرجاع الجدول بالتنسيق التالي بالضبط:',
      '',
      '• الخامة: [اكتشف نوع القماش من النص]',
      '• الصناعة: [حدد جودة التصنيع]  ',
      '• التصميم: [استخرج النمط والتفاصيل]',
      '• الألوان: [جميع الألوان المذكورة]',
      '• المقاسات: [جميع المقاسات المذكورة]',
      '• الميزات: [3 مميزات رئيسية]',
      '',
      'مثال:',
      '• الخامة: شيفون مبطن عالي الجودة',
      '• الصناعة: تصنيع محلي متقن  ',
      '• التصميم: شرقي خليجي بتطريز ذهبي',
      '• الألوان: أسود، أحمر، بنفسجي  ',
      '• المقاسات: M، L، XL',
      '• الميزات: تطريز متقن - مريح للارتداء - أنيق للمناسبات',
      '',
      'إذا لم تتبع هذا التنسيق بالضبط، ستفشل العملية. ثم أعِد JSON بهذه الحقول فقط: {"name":string,"description":string,"price":number?,"colors":string[]?,"sizes":string[]?,"keywords":string[]?,"stock":number?}',
      'قيود الاسم: يجب أن يكون 8-12 كلمة ويجمع النوع+المادة+التصميم+الميزات.'
    ].join('\n')
    const payload = {
      model,
      messages: [
