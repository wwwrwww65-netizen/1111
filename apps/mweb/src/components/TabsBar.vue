<template>
  <nav class="tabs" :class="{ sticky: stuck }" role="tablist" dir="rtl">
...
const props = defineProps<{ tabs: string[]; active?: string }>()
...
.tabs.sticky{background:var(--surface,#fff);box-shadow:0 1px 6px rgba(0,0,0,.04)}
