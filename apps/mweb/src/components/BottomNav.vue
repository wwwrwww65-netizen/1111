...
<style scoped>
.bottom-nav{position:sticky;bottom:0;inset-inline:0;display:grid;grid-template-columns:repeat(5,1fr);background:#fff;border-top:1px solid var(--muted-2);padding:6px 4px;z-index:40}
