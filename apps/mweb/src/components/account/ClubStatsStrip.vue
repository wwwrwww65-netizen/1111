<template>
  <section class="card" dir="rtl" aria-label="إحصاءات النادي">
    <div class="cells">
      ...
      <div class="sep"></div>
      <div class="cell" role="button" aria-label="هذا الشهر 15"><span class="v">{{ user.monthPoints }}x</span><span class="k">هذا الشهر</span></div>
      <div class="sep"></div>
      <div class="cell" role="button" aria-label="الشهر الماضي 10"><span class="v">{{ user.lastMonthPoints }}x</span><span class="k">الشهر الماضي</span></div>
    </div>
    <div class="offer" role="button" aria-label="عرض 22.99 مقابل 33.99">
      <span class="tx">عرض: <strong>22.99</strong> (93 نقطة) بدل <s>33.99</s></span>
    </div>
  </section>
</template>
...
.sep{width:1px;height:26px;background:#EDEDED}
