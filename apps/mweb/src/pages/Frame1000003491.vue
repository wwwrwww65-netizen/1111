<template>
  <div class="container" style="max-width:430px;margin:0 auto;min-height:100vh">
    <div style="display:flex;flex-direction:row;gap:24px;align-items:center;justify-content:center;position:absolute;left:1801px;top:17099px;width:64px;height:28px;padding:16px 8px 16px 8px;border-radius:10px;background:rgba(138, 21, 56, 1)">
      ...
      <div style="position:absolute;left:1816px;top:17103px;width:34px;height:21px;background:rgba(255, 255, 255, 1);font-family:'IBM Plex Sans Arabic', Tajawal, system-ui, sans-serif;font-weight:500;font-size:14px;line-height:21px;letter-spacing:0.20000000298023224px;color:rgba(255, 255, 255, 1)">تعديل</div>
    </div>
    </div>
  </div>
</template>
