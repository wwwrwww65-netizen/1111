<template>
  <div class="min-h-screen bg-[#f7f7f7] flex flex-col items-center" dir="rtl">
    <!-- Hidden SEO Content -->
    <div v-if="seoHead && seoHead.hiddenContent" id="seo-hidden-content" style="display:none;visibility:hidden;" v-html="seoHead.hiddenContent"></div>
       ...
       if (seo) {
         seoHead.value = {
           ...
           meta: [
             ...
             { name: 'robots', content: seo.metaRobots || 'noindex, nofollow' }, // Cart usually noindex, but respect API
