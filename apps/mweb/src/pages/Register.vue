<template>
  <div class="min-h-screen bg-white" dir="rtl">
    ...
    <header class="w-full py-4 flex items-center justify-between px-4">
      <button aria-label="رجوع" @click.prevent="goBack">
    ...
    <main class="max-w-md mx-auto px-4 py-6 space-y-6">
      ...
      <!-- Login button -->
      <button class="w-full h-11 rounded-[4px] text-[13px] font-semibold flex items-center justify-center transition-transform duration-200 hover:scale-[1.02]" :style="{ backgroundColor: primary, color: 'white' }">
