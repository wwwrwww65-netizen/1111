<template>
  <div class="container">
    <div style="position:absolute;left:-4149px;top:-708px;width:356px;height:30px">
      <div style="position:absolute;left:-4149px;top:-708px;width:356px;height:30px;border-radius:50px">
      <div style="position:absolute;left:-3836px;top:-702px;width:32px;height:16px;background:rgba(120, 137, 136, 1)">جاكيت</div>
