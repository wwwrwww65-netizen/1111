...
export default function UsersPage(): JSX.Element {
  ...
  async function load(){
    ...
    if (r.ok) setRows((r.data.users||[]).map((x:any)=> ({ id:x.id, name:x.name, email:x.email, phone:x.phone, sessions:Number(x.sessions||0), lastSeen:x.lastSeen, country:x.country, city:x.city, ip:x.ip })));
  }
