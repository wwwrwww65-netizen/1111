...
export default function InvoicesPaymentsPage(): JSX.Element {
  ...
  function exportCsv(){
    if (tab==='invoices'){
      downloadCsv(`invoices_${new Date().toISOString().slice(0,10)}.csv`, [
      ...
      downloadCsv(`schedule_${new Date().toISOString().slice(0,10)}.csv`, [
