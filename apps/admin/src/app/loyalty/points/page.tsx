...
export default function LoyaltyPointsPage(): JSX.Element {
  ...
  function exportCsv(){
    ...
    const a = document.createElement('a'); a.href = URL.createObjectURL(blob); a.download = `points_accounts_${new Date().toISOString().slice(0,10)}.csv`; a.click(); setTimeout(()=>URL.revokeObjectURL(a.href), 3000);
  }
