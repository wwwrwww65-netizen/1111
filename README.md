...
5) **المقاسات/الألوان/المخزون**: تُستخرج فقط إذا ذُكرت بوضوح. الألوان يجب أن تكون أسماء صريحة؛ تُرفض العبارات العامة (مثل "ألوان متعددة"). عند "فري سايز" تكون `sizes:["فري سايز"]` والوزن في صف بالجدول إن وجد.
...
#### تأثيرات على التجربة
- الاسم لن يُقص بعد الآن، والوصف سيكون جدولاً منسقاً عندما يوفّره DeepSeek، والأسعار/الألوان/المقاسات تُملأ فقط إذا أعادتها DeepSeek وبحسب القواعد بالأعلى. الصور تُستخدم فقط لاستخراج لوحات ألوان استرشادية دون تغيير ناتج DeepSeek.
